...
CREATE TABLE `commande` (
  ...
  `commande_date_reglem` date DEFAULT NULL,
  ...
  `commande_etat` varchar(10) DEFAULT NULL,
...
CREATE TABLE `contient` (
  ...
  `contient_qtite_liv` int(11) DEFAULT NULL,
...
INSERT INTO `fournisseur` VALUES (1,'Amet Orci PC','Appartement 402-3526 Massa Rue',88835,'Cinisi','09 65 12 45 03','Riddle','Orlando'),(2,'Integer Vulputate Risus Consulting','4509 Libero Chemin',91003,'Mazenzele','07 12 88 74 07','Harper','Edan'),(3,'Maecenas Malesuada Inc.','Appartement 975-1252 Odio. Impasse',55361,'Washington','07 09 79 41 97','Dale','Lucius'),(4,'Dictum Mi Ac Inc.','Appartement 245-2355 Auctor, Route',21846,'Vandoeuvre-lès-Nancy','09 04 52 00 84','Holden','Dorian'),(5,'Eleifend Vitae Industries','Appartement 536-5751 Neque Rue',12959,'San Nicolás','08 04 60 78 18','Herman','Aurora'),(6,'Nunc Quis Arcu Corporation','491-9263 Aenean Avenue',56602,'Werder','08 30 54 07 77','Cruz','Alvin'),(7,'A Sollicitudin Consulting','Appartement 142-1903 Libero Rue',23030,'White Rock','02 08 93 32 17','Santana','Carissa'),(8,'Pede Suspendisse Dui LLC','5319 Vel Impasse',33597,'Conca Casale','04 94 93 11 70','Weeks','Imogene'),(9,'Ac LLP','985-4900 Nunc Rd.',81603,'Acireale','03 56 76 73 66','Greene','Kaden'),(10,'Nunc In Associates','CP 707, 7848 Aliquam Rue',23124,'Piancastagnaio','02 97 66 61 89','Mclaughlin','Porter'),(11,'Ante Maecenas Mi Company','CP 384, 6634 Consequat Ave',61451,'Silvan','03 76 85 27 29','Potter','Pamela'),(12,'Sodales Elit Associates','CP 258, 5538 Id, Chemin',92254,'Duncan','09 50 74 79 06','Ramos','Wyatt'),(13,'Ligula LLC','410-7821 Fermentum Avenue',53877,'Rebecq','05 20 62 95 62','Melton','Kirby'),(14,'Enim Incorporated','CP 335, 9413 Tempor Chemin',46699,'Chittoor','02 49 15 14 43','Paul','Rae'),(15,'Nisi Sem Foundation','8400 Euismod Av.',40680,'Harelbeke','03 17 66 20 36','Dudley','Baxter'),(16,'Ut Consulting','2585 Facilisis. Rd.',67963,'Bihar Sharif','05 70 60 78 37','Pittman','Rigel'),(17,'Sed Pharetra Institute','7928 Neque Ave',58634,'Camerino','07 65 17 44 66','Wynn','Cameron'),(18,'Consequat Auctor Consulting','321-7248 Sed Rd.',76839,'Rutland','06 28 82 66 31','Stanton','Garrett'),(19,'Vestibulum Lorem Institute','CP 867, 668 Ornare. Route',85913,'Vance','08 50 01 02 15','Burris','Raphael'),(20,'In Tincidunt Limited','877-7388 Ornare Av.',32377,'LaSalle','05 61 82 84 18','Best','Forrest');
...
/*!50001 CREATE TABLE `produit_fournisseur` (
  ...
  `en stock` tinyint NOT NULL,
  `prix HT` tinyint NOT NULL,
  `quantité alerte` tinyint NOT NULL,
  `sous rubrique` tinyint NOT NULL,
  `prix fournisseur` tinyint NOT NULL,
...
CREATE TABLE `secomposede` (
  ...
  `secomposede_qtite_commande` int(11) NOT NULL,
